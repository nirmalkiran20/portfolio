...
export function BentoCard({
  ...
  const spanClasses = `${rowSpan ? `row-span-${rowSpan}` : ""} ${
  ...
  const cardContent = (
    ...
    >
      ...
      {showHoverGradient && (
        <div className="pointer-events-none absolute inset-0 z-30 user-select-none bg-gradient-to-tl from-indigo-400/20 via-transparent to-transparent opacity-0 transition-opacity duration-300 ease-in-out group-hover:opacity-100" />
      )}
