...
export function Timeline({ avatarUrl }: { avatarUrl: string }) {
  ...
  return (
    <div ref={containerRef} className="relative h-[calc(100%-2rem)] w-full">
      <motion.div
        className="absolute -left-0.5 z-10 flex"
        style={{
          top: 0,
          height: "100%",
          y: useTransform(scrollYProgress, [0, 1], ["calc(100% - 2rem)", "0%"]),
        }}
      >
