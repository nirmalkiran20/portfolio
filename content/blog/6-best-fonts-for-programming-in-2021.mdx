...
summary: "How to change the default highlight color of selected text using CSS."
imageName: "change-text-highlight-color-with-css.jpeg"
categories: ["Content Marketing"] # <-- ADD THIS LINE
canonicalUrl: ""
draft: false
---
